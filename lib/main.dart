...
import 'package:news_app/widgets/NavBody.dart';
...
class _MyHomePageState extends State<MyHomePage> with WindowListener {
  ...
  List<NavigationPaneItem> items = [
    ...
    PaneItem(
      ...
      body: const NavBody(header: 'Business', widget: Text('Business'),)
    ),
    PaneItemSeparator(),
    PaneItem(
    ...
    PaneItem(
      ...
      body: const NavBody(header: 'Entertainment', widget: Text('Entertainment')),
      onTap: () => {
        ...
        pane: NavigationPane(
          ...
          footerItems: [
            PaneItem(
              ...
              body: const NavBody(header: '', widget: null),
            ),
          ],
        ),
        // content:
            ...
            return ContentDialog(
              ...
              actions: [
                FilledButton(
                    onPressed: () {
                      Navigator.pop(
                         viewKey.currentContext as BuildContext);
